...
- Development and preview use the shared fixed loopback wrapper on 46311 and 46281, failing on conflicts. Package-local pnpm test builds and validates pages, legacy routes, public content and installer bytes.
