...
- Keep the confirmed Unix self-daemonization lifetime gap visible in public compatibility guidance until the required descendant-ownership behavior is implemented and verified.
