...
- `apps/devhud`: implemented deterministic bilingual React/TypeScript shell, complete guest/Logto identity, synchronized Settings and opt-in diagnostics boundaries, and target-isolated Rust/Tauri desktop CEF plus iOS/Android system-webview hosts; capture/GitHub product workflows and native widgets remain planned.
