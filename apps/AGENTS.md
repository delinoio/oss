...
- `apps/devhud`: implemented deterministic bilingual React/TypeScript shell, complete guest/Logto identity, synchronized Settings and opt-in diagnostics boundaries, direct-client GitHub.com provider/setup foundation, and target-isolated Rust/Tauri desktop CEF plus iOS/Android system-webview hosts; capture/populated product surfaces and native widgets remain planned.
