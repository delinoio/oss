...
- `apps/devhud`: implemented deterministic bilingual React/TypeScript shell, complete guest/Logto identity and synchronized Settings boundary, direct-client GitHub.com provider/setup foundation, populated Deck surface, and target-isolated Rust/Tauri desktop CEF plus iOS/Android system-webview hosts; capture, populated issue-result surfaces, and native widgets remain planned.
