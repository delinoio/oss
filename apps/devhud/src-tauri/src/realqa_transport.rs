...
fn map_error_reason(reason: u64) -> Option<RealQaTransportFailure> {
    match reason {
        ...
        8 => Some(RealQaTransportFailure::PresetLimitExceeded),
        9 => Some(RealQaTransportFailure::DeviceShortcutLimitExceeded),
        10 => Some(RealQaTransportFailure::GithubDisconnected),
        13 => Some(RealQaTransportFailure::GithubUnavailable),
        14 => Some(RealQaTransportFailure::ProviderValidationFailed),
...
mod tests {
    ...
    fn connect_errors_prefer_closed_realqa_error_details() {
        ...
        for (reason, expected) in [
            ...
            (8, RealQaTransportFailure::PresetLimitExceeded),
            (9, RealQaTransportFailure::DeviceShortcutLimitExceeded),
            (10, RealQaTransportFailure::GithubDisconnected),
            (13, RealQaTransportFailure::GithubUnavailable),
            (14, RealQaTransportFailure::ProviderValidationFailed),
