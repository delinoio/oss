...
`cef-pins.json` also binds each architecture-specific executable AppImage Sharun launcher to its SHA-256 digest. The desktop wrapper verifies the selected asset before making its bytes available to AppImage packaging.
