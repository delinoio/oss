...
export const messages = {
  ...
  ko: {
    ...
    signIn: "로그인", continueLocally: "로컬에서 계속", pat: "GitHub PAT 만들기", issue: "이슈 신고", fetchingBootstrap: "인증 구성을 확인하는 중…", bootstrapFailed: "이 API의 인증 구성을 검증할 수 없습니다.", signInFailed: "안전한 로그인을 시작할 수 없습니다.",
    signedInSession: "로그인 세션", signedIn: "로그인됨", logout: "로그아웃", deleteAccount: "계정 삭제", cancel: "취소", deleteAccountConfirmTitle: "계정 삭제를 예약할까요?", deleteAccountConfirmSummary: "접근은 즉시 차단됩니다. 동기화 데이터는 30일 동안 복구할 수 있으며 로컬 PAT와 R2 자격 증명은 지금 삭제됩니다.", accountActionFailed: "계정 작업을 완료할 수 없습니다.", deletionPendingTitle: "계정 삭제 예약됨", deletionPendingSummary: "인증 서비스 접근이 차단되었습니다. 30일 안에 복원하거나 로그아웃하여 복구 세션을 삭제하세요.", recoverableUntil: "복구 가능 기한", restoreAccount: "계정 복원",
