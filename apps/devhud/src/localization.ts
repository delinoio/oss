...
export const messages = {
  en: {
    ...
    offline: "Offline", offlineTitle: "You are offline", offlineSummary: "Cached local information remains available. Synchronized settings stay read-only until the connection returns.", lastSuccessfulRefresh: "Showing the last successful refresh.",
    ...
    mobileNavigation: "Primary navigation", desktopOnly: "Desktop only", notificationPermission: "Notification permission", updatePolicy: "Updates are managed by your app store.",
  },
  ko: {
    appName: "DevHUD",
    ...
    offline: "오프라인", offlineTitle: "오프라인 상태입니다", offlineSummary: "캐시된 로컬 정보는 계속 사용할 수 있습니다. 연결이 복구될 때까지 동기화 설정은 읽기 전용입니다.", lastSuccessfulRefresh: "마지막으로 성공한 새로 고침 결과를 표시합니다.",
    ...
    mobileNavigation: "기본 탐색", desktopOnly: "데스크톱 전용", notificationPermission: "알림 권한", updatePolicy: "업데이트는 앱 스토어에서 관리합니다.",
  },
} as const;
