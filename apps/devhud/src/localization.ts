...
export const messages = {
  en: {
    ...
    deckTitle: "Keep pull requests in view", deckSummary: "Deck refreshes GitHub directly with the credential profile you select.", deckCreate: "Create Deck", deckName: "Deck name", deckProfile: "Credential profile", deckQuery: "GitHub PR query", deckBuilder: "Query builder", deckRefresh: "Refresh now", deckDelete: "Delete Deck", deckNoProfiles: "Add a GitHub credential profile before creating a Deck.", deckRequirePullRequests: "The query must include is:pr.", deckStale: "Showing cached, stale results.", deckRateReset: "GitHub rate limit resets", deckErrorToken: "The selected credential has no usable PAT on this device.", deckErrorPermission: "The selected credential cannot read these pull requests.", deckErrorQuery: "GitHub could not run this pull-request query.", deckErrorNetwork: "DevHUD could not reach GitHub.", deckErrorRate: "GitHub rate-limited this Deck.", deckNotifications: "Notify for changes", deckResults: "Pull requests",
