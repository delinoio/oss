...
export const messages = {
  en: {
    ...
    deckTitle: "Keep pull requests in view", deckSummary: "Deck refreshes GitHub directly with the credential profile you select.", deckCreate: "Create Deck", deckName: "Deck name", deckProfile: "Credential profile", deckQuery: "GitHub PR query", deckBuilder: "Query builder", deckBuilderRepository: "Repository", deckBuilderAuthor: "Author", deckBuilderLabel: "Label", deckBuilderReview: "Review", deckBuilderState: "State", deckAny: "Any", deckApproved: "Approved", deckChangesRequested: "Changes requested", deckRequired: "Required", deckOpen: "Open", deckClosed: "Closed", deckMerged: "Merged", deckRefreshInterval: "Refresh", deckMinutes: "min", deckShowDrafts: "Show drafts", deckRefresh: "Refresh now", deckDelete: "Delete Deck", deckNoProfiles: "Add a GitHub credential profile before creating a Deck.", deckRequirePullRequests: "The query must include is:pr.", deckRequireRepository: "The query must include a repository.", deckStale: "Showing cached, stale results.", deckRateReset: "GitHub rate limit resets", deckErrorToken: "The selected credential has no usable PAT on this device.", deckErrorPermission: "The selected credential cannot read these pull requests.", deckErrorQuery: "GitHub could not run this pull-request query.", deckErrorNetwork: "DevHUD could not reach GitHub.", deckErrorRate: "GitHub rate-limited this Deck.", deckNotifications: "Notify for changes", deckResults: "Pull requests",
  ...
  ko: {
    ...
    deckTitle: "풀 리퀘스트 한눈에 보기", deckSummary: "선택한 자격 증명 프로필로 GitHub를 직접 새로 고칩니다.", deckCreate: "Deck 만들기", deckName: "Deck 이름", deckProfile: "자격 증명 프로필", deckQuery: "GitHub PR 쿼리", deckBuilder: "쿼리 빌더", deckBuilderRepository: "저장소", deckBuilderAuthor: "작성자", deckBuilderLabel: "레이블", deckBuilderReview: "리뷰", deckBuilderState: "상태", deckAny: "전체", deckApproved: "승인됨", deckChangesRequested: "변경 요청됨", deckRequired: "필수", deckOpen: "열림", deckClosed: "닫힘", deckMerged: "병합됨", deckRefreshInterval: "새로 고침", deckMinutes: "분", deckShowDrafts: "초안 표시", deckRefresh: "지금 새로 고침", deckDelete: "Deck 삭제", deckNoProfiles: "Deck을 만들기 전에 GitHub 자격 증명 프로필을 추가하세요.", deckRequirePullRequests: "쿼리에 is:pr이 포함되어야 합니다.", deckRequireRepository: "쿼리에 저장소가 포함되어야 합니다.", deckStale: "캐시된 오래된 결과를 표시합니다.", deckRateReset: "GitHub 제한 재설정", deckErrorToken: "선택한 자격 증명에 이 기기에서 사용할 PAT가 없습니다.", deckErrorPermission: "선택한 자격 증명으로 이 풀 리퀘스트를 읽을 수 없습니다.", deckErrorQuery: "GitHub에서 이 풀 리퀘스트 쿼리를 실행하지 못했습니다.", deckErrorNetwork: "GitHub에 연결할 수 없습니다.", deckErrorRate: "GitHub에서 이 Deck의 요청을 제한했습니다.", deckNotifications: "변경 알림", deckResults: "풀 리퀘스트",
