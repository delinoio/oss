...
export const messages = {
  ...
  ko: {
    ...
    githubErrorMissingToken: "이 프로필의 PAT가 보안 저장소에 없습니다. 이 장치에서 PAT를 입력하고 저장하세요.", githubErrorInvalidToken: "GitHub에서 이 PAT를 유효하지 않은 것으로 거부했습니다.", githubErrorMissingScope: "이 PAT에 필요한 권한 또는 클래식 repo 범위가 없습니다.", githubErrorRepositoryRestriction: "이 세분화된 PAT는 할당된 저장소 중 하나에 접근할 수 없습니다.", githubErrorOrganizationDenied: "조직의 SSO, 승인 또는 접근 정책으로 이 PAT가 거부되었습니다.", githubErrorRateLimited: "GitHub에서 검증 요청을 속도 제한했습니다. 제한이 초기화된 후 다시 시도하세요.", githubErrorNetwork: "GitHub에 연결할 수 없습니다. 네트워크를 확인하고 다시 시도하세요.",
  },
} as const;
