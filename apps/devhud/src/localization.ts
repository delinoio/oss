...
export const messages = {
  en: {
    ...
    githubSetProfileToken: "PAT for this device", githubSaveProfileToken: "Validate and save PAT", githubValidateProfile: "Validate all assigned repositories", githubRemoveProfile: "Remove profile", githubAssignments: "Repository profile assignments", githubSelectProfile: "Select a profile", githubIssueTracker: "Issue tracker", githubDeck: "Deck", githubProfileSaved: "GitHub profile saved securely.", githubProfileRemoved: "GitHub profile removed.", githubProfileInUse: "Assign every referenced repository to another profile before removing this profile.", githubValidationPassed: "The selected credential passed validation for every assigned repository.", githubSetupFailed: "DevHUD could not complete GitHub setup. No sensitive details were logged.",
