...
export function hasCompletedOnboarding(storage: Pick<Storage, "getItem">) { return storage.getItem(onboardingKey) === "complete"; }
export function completeOnboarding(storage: Pick<Storage, "setItem">) { storage.setItem(onboardingKey, "complete"); }
