...
Install binpm by following the [binpm installation docs](https://binpm.delino.io/installation). After binpm is installed, add Nodeup from the first-party `delinoio/oss` release asset:
