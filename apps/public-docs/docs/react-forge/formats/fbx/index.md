...
Available in npm `0.2.0`. Create and export static scenes using `createSession(Format.Fbx)` and the `@delino/react-forge/fbx` entry point. Existing FBX import/editing, animation, rigging, and advanced shaders are excluded.
