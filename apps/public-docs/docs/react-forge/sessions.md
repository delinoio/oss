...
For the components and export behavior of a specific format, continue with [PPTX](/react-forge/pptx), [DOCX](/react-forge/docx), [XLSX](/react-forge/xlsx), or [PDF](/react-forge/pdf). Imported Office files use [mounted editing regions](/react-forge/office-editing) instead of a root render.
