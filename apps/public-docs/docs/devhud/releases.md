...
Desktop release evidence includes platform signatures, SHA-256 checksums, provenance, software-bill-of-materials data, and signed updater manifests. The updater checks the installed package type, validates the stable manifest and artifact, and requires explicit approval before download, installation, and restart.
