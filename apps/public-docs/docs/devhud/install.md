...
Install DevHud from the Chrome Web Store. The extension is a permission-scoped context picker: it does not observe pages or collect cookies, storage, console output, or network traffic. Pair it from DevHud Settings after installing the desktop app.
