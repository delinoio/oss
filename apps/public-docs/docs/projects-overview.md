...
- [`runmoor`](runmoor): Stable manager for disposable Docker and Tart GitHub Actions runners on a personal computer.
...
Standalone project documentation links remain canonical for Nodeup and binpm; Runmoor public guidance is canonical under `/runmoor`.
