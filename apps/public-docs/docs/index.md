...
- Open [Runmoor](runmoor) for the integrated Runmoor guides, or use the top navigation to switch to the standalone [Nodeup](https://nodeup.delino.io) and [binpm](https://binpm.delino.io) documentation sites.
...
Nodeup and binpm keep their standalone documentation sites, while Runmoor is integrated under the `/runmoor` route.
