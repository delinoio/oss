...
const descriptions: Record<Operation, string> = {
  ...
  export: "Export Office/PDF/GLB/FBX to a local output. overwrite=true replaces an existing output, never an imported source or its aliases. Atomic publication pins a revision. Figma uses publish instead.",
