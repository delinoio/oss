...
export const capabilities = Object.freeze({
  ...
  formats: Object.freeze({
    [Format.Glb]: Object.freeze({ generate: true, import: false, coordinateSpace: "world", staticOnly: false, animation: true, skinning: true, morphTargets: true, embeddedTextures: true }),
    [Format.Fbx]: Object.freeze({ generate: true, import: false, coordinateSpace: "world", staticOnly: false, animation: true, skinning: true, morphTargets: true, embeddedTextures: true, materialProfile: "blender-4.5" }),
