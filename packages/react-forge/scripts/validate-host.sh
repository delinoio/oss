...
cargo test --locked --target "$target" -p react-forge-node -p forge-package -p forge-document -p forge-docx -p forge-xlsx -p forge-pdf -p forge-sprite -p forge-sfx -p forge-figma -p forge-scene -p forge-glb -p forge-fbx -p forge-tree-doc -p forge-pptx -p delino-forge
cargo test --locked --target "$target" -p forge-document -p forge-pdf -- --include-ignored
cargo clippy --locked --target "$target" -p react-forge-node -p forge-package -p forge-document -p forge-docx -p forge-xlsx -p forge-pdf -p forge-sprite -p forge-sfx -p forge-figma -p forge-scene -p forge-glb -p forge-fbx --all-targets -- -D warnings
