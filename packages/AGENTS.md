...
- The API client must retain package-local typecheck, lint, unit, and build Vite Task definitions for path-gated CI execution. Its generated output is cacheable only when derived from the committed schemas and lockfile.
