...
- Crash diagnostics are typed, user-previewed, and redacted, with a 4 KiB summary and 32 KiB stack ceiling. Administrator message graphs must not reach settings bodies, secrets, DOM, screenshots, Deck results, agent output, or local paths.
