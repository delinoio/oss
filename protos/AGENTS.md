...
- CI must validate schema formatting, lint, compatibility, and generated-client freshness through package/root commands and the committed Vite Task binary. Generated Go and TypeScript outputs are deterministic cacheable products and must never be edited by hand.
