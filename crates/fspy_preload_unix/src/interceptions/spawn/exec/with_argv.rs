...
#[expect(
    ...
    reason = "arg0 and argc are standard C naming conventions"
)]
pub unsafe fn with_argv(
    ...
    let out = if argc < 32 {
        ...
        // SAFETY: ptr is non-null (checked above), properly aligned, and points to argc
        // elements worth of allocated memory
