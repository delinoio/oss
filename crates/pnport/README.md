...
Current restrictions include macOS native thin Mach-O admission only, no script
interpreter chain, no complete fork/exec/posix_spawnp propagation, no complete
mutation/handle/watch coverage, no detached-descendant recovery or terminal
