...
Inspect dotenv keys, merge dotenv configuration layers, and normalize YAML references with portable local commands. Help and version output remain available.
