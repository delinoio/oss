...
Portable offline text replacement, time formatting/arithmetic, Base64 encoding/decoding, and checksum generation/verification for scripts and local workflows.
