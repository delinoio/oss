...
unsafe extern "C" fn scandir(
    ...
    unsafe { handle_open(crate::client::convert::PathAt::borrow_raw(libc::AT_FDCWD, dirname), AccessMode::READ_DIR) }
...
unsafe extern "C" fn opendir(dir_name: *const c_char) -> *mut DIR {
    ...
    unsafe { handle_open(crate::client::convert::PathAt::borrow_raw(libc::AT_FDCWD, dir_name), AccessMode::READ_DIR) };
