...
- Install signal handlers only for the selected command family: private configuration runtime cancellation returns numeric 130/143 after cleanup, while the utility runtime preserves delegated child and OS signal semantics.
