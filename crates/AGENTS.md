...
- Cross-command tests must account for Windows `env run` variable conversion, including numeric `$1` references, separately from direct transformation capture parsing and literal npm launcher forwarding.
