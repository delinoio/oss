...
/// Validation result with typia-compatible success/failure discriminator.
...
/// Validation error detail compatible with typia's validate() payload shape.
#[derive(Debug, Clone, PartialEq)]
...
/// Runtime representation for derive-time typia tags.
#[derive(Debug, Clone, PartialEq)]
pub enum TagRuntime {
    MinLength(usize),
    MaxLength(usize),
