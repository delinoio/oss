...
- Filesystem identities are fallible UTF-8 paths; reject invalid bytes in roots, native projects, inputs, outputs, and link targets before matching, hashing, or serialization. Never use lossy conversion for identity keys.
