...
- Keep `docs/crates-taskflow-conformance.md` and the native/Docker CI matrices synchronized. CI result bundles must prove complete task, artifact, and shard accounting against the exact plan; secret transport is forbidden for PR jobs.
