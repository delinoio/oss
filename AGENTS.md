...
- DevHud public release contract: reuse and revalidate the complete private signed candidate before external action; fail closed across every documented signing, store, GitHub, Logto, PostgreSQL, R2, asset, registry, docs, and provider-neutral deployment boundary; wait on protected review gates; and serialize infrastructure, all stores, regular GitHub Release, updater, public docs, independent verification, and GA without beta or partial GA.
