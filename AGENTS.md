...
- `docs/crates-clibox-fspy-contract.md`: issue #971 file-access workflow and trace contract.
...
- `clibox` -> `crates/clibox`, `crates/clibox-config`, `crates/clibox-system`, `crates/clibox-transform`, `crates/clibox-wait`, `crates/clibox-fspy`, `packages/clibox`, `apps/public-docs/docs/clibox`
