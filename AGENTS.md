...
- `servers/delibase` owns Go/PostgreSQL/sqlc persistence, organization/team/invitation policy, immutable membership and provider identities, append-only billing and reservation invariants, provider integrations, server configuration, and future GHCR artifacts.
