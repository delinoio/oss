...
- `protos/dexdex/v1/*.proto`: Shared DexDex Connect RPC service and enum/message contracts (`dexdex.v1`).
...
- `dexdex` -> `crates/dexdex-main-server`, `crates/dexdex-worker-server`, `apps/dexdex`, `protos/dexdex`
