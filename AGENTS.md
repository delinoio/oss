...
- React Forge also owns `crates/forge-scene`, `crates/forge-glb` and `crates/forge-fbx` for generation-only static GLB/FBX. Follow `docs/packages-react-forge-scene-contract.md`; runtime generation remains local and converter-free.
