...
- Full Unix descendant ownership is still required but currently has a confirmed daemonization-before-sampling gap. Do not claim this acceptance criterion complete or close its review thread based on faster polling or environment markers alone; see the command contract and evidence.
