...
func (s *Service) authorizeRequest(r *http.Request) (*http.Request, func(), error) {
	...
	if actor.Type == domain.WorkerDevice {
		switch r.URL.Path {
		case delidevv1connect.WorkerServiceAttachWorkerProcedure, delidevv1connect.WorkerServiceWatchWorkProcedure, delidevv1connect.WorkerServiceReportWorkProcedure, delidevv1connect.WorkerServiceRegisterExecutionProcedure, delidevv1connect.SystemServiceGetStatusProcedure:
		default:
