...
ALTER TABLE polar_meter_mappings
    ADD CONSTRAINT polar_meter_mappings_provider_id_check CHECK (
        ...
        -- POSIX space classes depend on the database locale. This explicit
        -- cutset mirrors the Unicode White_Space set used by strings.TrimSpace.
        AND polar_meter_id = btrim(
            polar_meter_id,
