...
const (
	...
	AuditBackgroundAuthorizationCreated         AuditEventType = "background_authorization.created"
	AuditBackgroundAuthorizationRevoked         AuditEventType = "background_authorization.revoked"
	AuditBackgroundAuthorizationAccessLost      AuditEventType = "background_authorization.access_lost"
	AuditBackgroundAuthorizationResourceDeleted AuditEventType = "background_authorization.resource_deleted"
	AuditBackgroundAuthorizationOwnerDeleted    AuditEventType = "background_authorization.owner_deleted"
