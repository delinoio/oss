...
- JSON output is a command output API for diagnostics and cache cleanup summaries only. Other mutating command progress logs and structured `tracing` logs are not stable machine-readable output contracts.
