...
- AppImage helper bundle: confirm that `verify:pins` accepts exactly the two committed Sharun bundles and that packaging rejects replacement bytes before Cargo starts.
