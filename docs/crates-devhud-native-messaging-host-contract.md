...
Revalidate browser-context text at the native boundary and reject titles, user agents, or individual accessibility values above 4 KiB of UTF-8 as invalid browser context.
