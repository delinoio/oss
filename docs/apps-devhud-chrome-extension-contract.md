...
Store only non-secret extension configuration and pairing state required by the app; pairing data remains local and is removed on logout or account deletion. Do not persist page captures beyond the app’s draft/submission contract.
