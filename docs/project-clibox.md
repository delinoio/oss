...
- Issue #971 adds unreleased `clibox fspy record`, `compare`, `assetcov`, `latencylab`, and `fbreak` on Linux; the other two workflows and macOS/Windows execution backends remain incomplete. See the dedicated file-access contract before describing this family as released.
