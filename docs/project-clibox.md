...
- Issue #971 adds seven unreleased `clibox fspy` workflows on Linux, including verified `min-repro` bundles; macOS/Windows execution backends and complete target validation remain outstanding. See the dedicated file-access contract before describing this family as released.
