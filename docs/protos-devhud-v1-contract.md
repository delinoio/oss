...
The current server consumes these generated bindings and registers Bootstrap, Settings, Upload, Account, and Admin. Diagnostics remains a wire-stable planned service and is deliberately not registered as a placeholder handler.
