...
The current server consumes these generated bindings and registers Bootstrap, Settings, Upload, and Account. Diagnostics and Admin remain wire-stable planned services and are deliberately not registered as placeholder handlers; upload administration is exposed only through internal hooks until AdminService is implemented.
