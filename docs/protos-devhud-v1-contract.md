...
The current server foundation consumes these generated bindings and registers Bootstrap, Settings, and Account only. Upload, Diagnostics, and Admin remain wire-stable planned services and are deliberately not registered as placeholder handlers.
