...
Diagnostics schema version 1 carries a required client UUID v7, up to 32 unique related UUID v7 values, a duration capped at 24 hours, armv7 as an explicit architecture, and exact Tauri/desktop CEF revision fields. Desktop reports require CEF and mobile reports require it to be empty.
