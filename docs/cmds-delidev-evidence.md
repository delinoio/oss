...
| Workers, executables, outbound jobs, processes, updates, services | Durable outbound job API, instance leases and uncertainty on replacement implemented; Worker executable loop, native process ownership, updates and services pending | Real Connect pairing/dispatch/report/revocation tests; no real harness execution |
