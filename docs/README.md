...
- `docs/apps-devhud-foundation.md` (`apps/devhud`, sole canonical implementation path; production desktop CEF shell, maintained mobile system-webview hosts, and build-only native widget foundation)
