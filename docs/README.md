...
- `docs/crates-clibox-foundation.md` (six private Rust crates: CLI composition, configuration, OS utilities, offline transformations, TCP/HTTP/file readiness, and file-access workflows; npm/native distribution only)
- `docs/crates-clibox-fspy-contract.md` (unreleased file-access workflow and trace contract)
