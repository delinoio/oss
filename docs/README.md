...
- Repository configuration, stable root development commands, local development modes, environment ownership, and secret classification are defined in `docs/repository-environment-contract.md`.
