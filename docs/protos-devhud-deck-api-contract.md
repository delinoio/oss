...
- PR results/details carry only repository, number, title, author, review decision, checks, mergeability, draft state, updated time, and the synchronized PR revision required by `MutatePullRequest` by default.
