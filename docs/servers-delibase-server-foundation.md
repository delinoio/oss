...
- Database constraints prevent overlapping price windows for one meter and overlapping billing periods for one organization, keep subscriptions and ledger periods in the billed organization, bind reservation prices to their meter, require overflow-safe reservation unit-price totals, and cap committed units at the reserved maximum.
