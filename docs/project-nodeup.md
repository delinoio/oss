...
- Its package-owned development server defaults to `46250`, accepts the temporary `NODEUP_DOCS_DEV_PORT` override, and permits root `pnpm dev` to select a logged free port when that default is occupied.
