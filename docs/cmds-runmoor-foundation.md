...
- This validation uses no live GitHub request, credentials, Docker/Tart execution or user-service installation and does not expand the preview's compatibility certification.
