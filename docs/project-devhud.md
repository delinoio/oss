...
- Official uploads use R2 signed direct uploads, with 50 MiB/object, 10 images/issue, 1 GiB rolling-24-hour, 20 GiB stored, 120 signed URLs/rolling-hour, and 300 public GETs/IP/minute limits. Staging expires after 24 hours; API logs and crash reports retain 30 days; pseudonymized security/audit events retain at most 180 days; account deletion purges user data after a 30-day recovery period.
