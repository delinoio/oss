...
- Desktop integration failures surface the effective native shortcut and launch-at-login state. A successful confirmed reset clears those startup diagnostics from the retained settings surface together with the native integrations and local records.
