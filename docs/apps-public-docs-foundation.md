...
- `/devhud` is the coordinated-release readiness page. It describes only public product availability, package/trust surfaces, and the all-channels GA rule; internal credentials, endpoints, workflow structure, and deployment implementation remain in repository contracts.
