...
TTL language contract integrated into the ttl project documentation set.
...
## Path
- Language spec document: `docs/project-ttl/feature-language-spec.md`
