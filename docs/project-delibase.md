...
- PostgreSQL constraints, transactions, and row locks enforce append-only ledger behavior, organization-scoped billing references, non-overlapping effective price/billing-period windows, reservation unit-price totals, commit caps, and concurrent reservation limits against available credits plus configured overage.
