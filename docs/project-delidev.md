...
- The app consumes the versioned `delibase.v1` Connect contract and, for Deck connection management only, `DeckIntegrationService` from `devhud.deck.v1`; it must update with the corresponding owning proto contract for any interface change.
