...
- The onboarding route admits only accounts whose server-authoritative state requires onboarding. Onboarding and invitation-acceptance retries retain their pending idempotency keys until success or their operation inputs change.
