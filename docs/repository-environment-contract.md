...
- `pnpm dev:public-docs` is the repository-root public documentation development entry point. Runmoor is developed through it because its routes are integrated into Public Docs; Nodeup and binpm documentation are maintained outside this repository. The command delegates directly to the workspace package and its fixed-port development wrapper without requiring the DevHud team environment.
