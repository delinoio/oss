...
| `devhud` | Local-only React/TypeScript/Rsbuild and Tauri application with a production tray-resident desktop shell, closed internal registry, and maintained standard system-webview mobile hosts with device-backup exclusions. | `apps/devhud` | `active` | [project-devhud](docs/project-devhud.md), [apps-devhud-foundation](docs/apps-devhud-foundation.md) |
