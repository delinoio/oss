...
| `devhud` | Local-only DevHud feasibility scaffold with an isolated macOS x64/ARM64 gate; the pinned CEF runtime fails macOS compilation and lacks Windows/Linux renderer-termination observation, so product and release work remain blocked. | `apps/devhud` | `gate-blocked` | [project-devhud](docs/project-devhud.md), [apps-devhud-foundation](docs/apps-devhud-foundation.md) |
