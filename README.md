...
| `devhud` | Local-only DevHud feasibility scaffold with a pinned Tauri CEF desktop probe; product, mobile/widget, CI, packaging, and release work are blocked by an upstream renderer-termination limitation. | `apps/devhud` | `gate-blocked` | [project-devhud](docs/project-devhud.md), [apps-devhud-foundation](docs/apps-devhud-foundation.md) |
