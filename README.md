...
| `devhud` | Local-only DevHud feasibility scaffold with a pinned Tauri CEF desktop probe and isolated macOS x64/ARM64 gate; product and cross-platform release work remain blocked by the Windows/Linux renderer-termination limitation. | `apps/devhud` | `gate-blocked` | [project-devhud](docs/project-devhud.md), [apps-devhud-foundation](docs/apps-devhud-foundation.md) |
